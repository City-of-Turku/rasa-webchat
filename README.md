...
| `showDeleteHistoryButton` | `false`            | Show button for deleting conversation history (in embedded mode in upper right corner of the chat window and otherwise in header) |
| `deleteHistoryConfirmTitle` | `'Delete conversation history'`            | Title in the pop-up used to confirm whether user wants to delete the conversation history.                                                                             |         
| `deleteHistoryConfirmSubtitle` | `'This operation cannot be undone'`            | Subtitle in the pop-up used to confirm whether user wants to delete the conversation history.                                                                             |         
| `deleteHistoryConfirmButton` | `'Delete'`            | Text on the button that confirms the deletion of the conversation history                                                                             |         
| `deleteHistoryCancelButton` | `'Cancel'`            | Text on the button that cancels the deletion of the conversation history                                                                             |                                                                   
